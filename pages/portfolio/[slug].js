    ...
    <div >
      ...
      <div className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-0' >
        ...
        <div className='flex justify-between items-center mt-4' >
          <p className='text-gray-800 mb-4' >{new Date(portfolioItem.date).toDateString()}</p>
          <div className='flex space-x-3 mt-2' >
            {portfolioItem.tags.map((tag) => (
              <span key={tag}
                className='text-white font-bold uppercase text-sm tracking-wide m-2 bg-blue-700 px-2 py-1 rounded-lg'
              >
                {tag}
              </span>
            ))}
